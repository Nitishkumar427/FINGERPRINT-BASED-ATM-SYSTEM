        ...
        with con:
            ...
            for row in rows:
                if row[0] == user and password == row[1]:
                    in_file = open("C:/Users/Nitis/OneDrive/Desktop/5. Fingerprint Based ATM/FingerprintATM/FingerprintATM/static/users/"+user+".png", "rb")
...
def SignupAction():
    if request.method == 'POST':
        ...
        if status == 'none':
            ...
            db_connection.commit()
            if db_cursor.rowcount == 1:
                out_file = open("C:/Users/Nitis/OneDrive/Desktop/5. Fingerprint Based ATM/FingerprintATM/FingerprintATM/static/users/"+user+".png", "wb")
                out_file.write(data)
                out_file.close()
